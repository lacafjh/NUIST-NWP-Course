...
contains
   subroutine cmf(rm, f, d, cla, m, n)
      implicit none
      real, intent(inout)                 :: d, cla, m, n
      real, dimension(m:n), intent(inout) :: rm, f
      real :: rk = 0.7156, rlq = 11423370.0, a = 6371000.0, conv = 57.29578,  &
            w1 = 2.0/rk, sita = 30.0/conv, psx = (90.0-cla)/conv,              &
            cel0, cel, r, xi0, xy, yj0, yj, rl, w2, sinl
